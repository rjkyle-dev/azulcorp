    ...
    <>
      <div className="relative">
        ...
        <section
          ...
          <div className="relative w-full sm:w-3/4 md:w-[450px] lg:w-[350px] xl:w-[70%] xl:top-[-40em] xl:left-[55em] mx-auto md:top-[-13em] md:left-[1em] lg:top-[140px] z-[10] top-[-12em]">
